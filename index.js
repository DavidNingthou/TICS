...
📈 **Exchange Breakdown:**
🔸 MEXC: \`${data.mexcPrice}\` (${data.mexcVolume.toLocaleString()}) | H: \`${data.mexcHigh}\` L: \`${data.mexcLow}\`
🔹 LBank: \`${data.lbankPrice}\` (${data.lbankVolume.toLocaleString()}) | H: \`${data.lbankHigh}\` L: \`${data.lbankLow}\`
